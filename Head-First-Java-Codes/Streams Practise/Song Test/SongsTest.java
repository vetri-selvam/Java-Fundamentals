...
class Songs{
 ...
 class Song {
  ...
  // Create a constructor
    ...
    // all the getters all the getters values
    ...
    public String toString() {
        return title +" by "+ artist+ " Genre: " +genre+  ". Year:" +year+ ". Times Played: " +timesPlayed +"\n" ;   
    }
 }
...
public class SongsTest {
    public static void main(String[] args) {
        List<Song> s= new Songs().getSongs();
        System.out.println(s);
    
// map  - List of genres in String type from List of Songs in Song type.  
    List<String> genres = s.stream()
